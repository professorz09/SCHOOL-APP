      ...
      <div className="bg-white border-b border-slate-100 px-4 pt-4 pb-0 sticky top-0 z-10 shadow-sm">
        <div className="flex items-center gap-3 pb-3">
          ...
          <div>
            ...
            <p className="text-[10px] font-bold text-slate-400">{teacherName} · Weekly Schedule</p>
          </div>
        </div>
      ...
      <div className="bg-white border-b border-slate-100 px-4 py-2.5">
        <div className="flex items-center justify-between">
          <span className="text-[9px] font-black uppercase tracking-widest text-slate-400">
            This week: {entries.length} periods
          </span>
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-[9px] font-bold text-slate-300">{entry.slot.label}</span>
                      {live && (
                    ...
                    {/* Subject */}
                    <div className="font-black text-slate-900 text-base">{entry.subject || 'Class'}</div>
