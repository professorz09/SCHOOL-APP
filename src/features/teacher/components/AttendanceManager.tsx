        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
          {classes.map((cls, idx) => (
            <button key={cls.id}
              ...
              <div className="bg-blue-50 text-blue-700 text-[9px] font-black px-2.5 py-1 rounded-lg uppercase">
                Mark
              </div>
            ...
            {filteredStudents.map((student, idx) => (
              <button key={student.id}
                ...
                {student.isPresent === true && (
                  <div className="bg-emerald-100 text-emerald-700 text-[10px] font-black px-3 py-1 rounded-lg uppercase tracking-wide">
                    PRESENT
                  </div>
                )}
                {student.isPresent === false && (
                  <div className="bg-rose-100 text-rose-600 text-[10px] font-black px-3 py-1 rounded-lg uppercase tracking-wide">
                    ABSENT
                  </div>
                )}
                {student.isPresent === null && (
                  <div className="bg-slate-100 text-slate-400 text-[10px] font-black px-3 py-1 rounded-lg uppercase tracking-wide">
                    —
                  </div>
                )}
